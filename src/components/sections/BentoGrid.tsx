      ...
      <div className="container relative z-10 px-6">
        ...
        <AnimatedSection delay={0.3}>
          <div className="mt-12 rounded-2xl bg-white border border-brand-navy-900/10 p-8 md:p-10 shadow-lg">
            ...
            <Button
              size="lg"
              className="group w-full bg-brand-green text-brand-navy-900 font-extrabold rounded-full px-2.5 py-1.5 sm:px-3 sm:py-2 text-sm sm:text-base shadow-[0_8px_20px_-8px_rgba(0,208,84,0.45)] hover:bg-brand-navy-900 hover:text-white hover:shadow-[0_16px_32px_-8px_rgba(1,17,51,0.5)] hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 ease-out leading-snug whitespace-normal focus:outline-none focus:ring-[3px] focus:ring-brand-cyan-500/35 h-auto"
            >
              <span className="flex-1 text-center">QUERO COMEÇAR OS&nbsp;30&nbsp;DIAS&nbsp;AGORA</span>
              <span className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white text-brand-navy-900 inline-flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.15)] flex-shrink-0 group-hover:rotate-[360deg] transition-all duration-500 ease-out">
